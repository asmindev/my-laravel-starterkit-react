    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Informasi dasar tentang kampanye Anda</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        placeholder="contoh: Newsletter Mingguan - Jan 2025"
                        required
                    />
                ...
                {/* <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">Biarkan kosong untuk menyimpan sebagai draf</p>
